...
import static ml.melun.mangaviewextended.Utils.getScreenSize;
import static ml.melun.mangaviewextended.Utils.hideSpinnerDropDown;
import static ml.melun.mangaviewextended.Utils.showCaptchaPopup;
import static ml.melun.mangaviewextended.Utils.showPopup;
import static ml.melun.mangaviewextended.Utils.showTokiCaptchaPopup;
import static ml.melun.mangaviewextended.activity.CaptchaActivity.RESULT_CAPTCHA;
import static ml.melun.mangaviewextended.mangaview.Title.LOAD_CAPTCHA;
import static ml.melun.mangaviewextended.mangaview.Title.LOAD_OK;
...
import ml.melun.mangaviewextended.Utils;
import ml.melun.mangaviewextended.adapter.CustomSpinnerAdapter;
import ml.melun.mangaviewextended.adapter.StripAdapter;
import ml.melun.mangaviewextended.mangaview.Comment;
...
import ml.melun.mangaviewextended.model.PageItem;
import ml.melun.mangaviewextended.ui.CustomSpinner;
import ml.melun.mangaviewextended.ui.StripLayoutManager;
        ...
        if (toolbarshow) {
            ...
            if (item != null) {
                ...
                commentBtn.setOnClickListener(v -> {
                    ...
                    Gson gson = new Gson();
                    List<Comment> temp = item.manga.getComments();
                    commentActivity.putExtra("comments", gson.toJson(temp));
